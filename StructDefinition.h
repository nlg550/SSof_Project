...
struct MemoryStack {
	std::map<unsigned long int, Attribute> value_attribute;
	std::map<unsigned long int, unsigned long int> value_address;
};
...
struct Registers {
	...
	std::map<std::string, unsigned long int> regAddress;
};
